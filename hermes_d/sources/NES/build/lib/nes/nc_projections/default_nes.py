...
from osgeo.gdal import UseExceptions, SetConfigOption
...
class Nes(object):
    ...
    def to_mbtile(
        ...
        for date in self.time:
            ...
            print(
                f"\tProcessing daily_{domain}_{date_part}.mbtiles file, date: {date_part}",
                flush=True,
            )
            ...
            filtered_shp.to_file(mbtiles, driver="MBTiles", **options)
