...
class SpeciationDelta(object):
    ...
    def initialize(self, pollutants, sector_name, debug) -> Tuple[DataFrame, DataFrame, List, Dict]:
        """
        ...
        debug: bool
            A boolean flag indicating whether to save the speciation profile for debugging purposes.
        Returns
        -------
