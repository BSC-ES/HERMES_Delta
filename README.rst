...
If using HERMES_Δ for research or publication, please cite appropriately once
citation details (paper/DOI) are available. (Paper in progress)
...
* `Paula Camps <https://www.bsc.es/camps-pla-paula>`_ – paula.camps@bsc.es
